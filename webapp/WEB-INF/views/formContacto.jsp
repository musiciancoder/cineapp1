...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		${instanciaContacto} <%-- Esto se expresa de acuerdo a toSring se clase modelo Contacto --%>
		  <form:form class="form-horizontal" method="post" action="${urlRoot}contacto" modelAttribute="instanciaContacto"><!--  modelAttribute="instanciaContacto" es la instancia que automaticamente crea el controlador (ContactoController) en el metodo mostrarformulario  --> 
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:select id="genero" path="generos" multiple="multiple" class="form-control" items="${generos}"/> <%-- //items="${generos}" desde clase de servicio --%>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  ...
                  <label><form:radiobutton path="rating" value="1"/>&nbsp;Muy Mala&nbsp;&nbsp;</label> <!-- path="rating" es el atributo llamado rating en la clase de modelo Contacto, por lo que aca estamos instanciando getRating(). 
                  (cont) Esto se logra porque en el controlador tenemos @ModelAttribute-->
            ...
            <div class="form-group">
               ...
               <form:checkboxes items="${tipos }" path="notificaciones"/> <!-- path="notificaciones" es el mismo nombre de variable definida en clase modelo; items="${tipos }" es el nombre dato en model.addAttribute -->

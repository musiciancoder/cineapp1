...
<html lang="en">
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <c:if test="${mensaje!=null}"> <!-- mensaje esta en metodo eliminar de PeliculasController -->
      
       <div class='alert alert-success' role="alert">${mensaje}</div> <!-- mensaje viene de flashattributes en metodo guardar del peliculascontroller -->
...
<li><a href="${urlDelete}/indexPaginate?page=${peliculas.number + 1 }">Siguiente</a></li>
</ul>
</nav> --%>

        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="form-group">
              ...
              <form:hidden path="id"/> <!-- tras bambalinas, el usuario no lo ve nunca; pasamos un id para la pelicula al presionar el boton guardar -->
        	<form:hidden path="detalle.id"/> <!-- tras bambalinas, el usuario no lo ve nunca; pasamos un id para detalles de la pelicula al presionar el boton guardar-->
